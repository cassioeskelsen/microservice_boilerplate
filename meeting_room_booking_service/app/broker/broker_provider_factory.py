...
class BrokerProviderFactory(object):
    ...
    @classmethod
    def get_instance(self, db_provider_class=DEFAULT_BROKER_PROVIDER_CLASS, broker_configuration=DEFAULT_BROKER_CONFIGURATION_CLASS):
        """
        ...
        if not BrokerProviderFactory._BROKER_PROVIDER:
            BrokerProviderFactory._BROKER_PROVIDER = db_provider_class(broker_configuration)
            BrokerProviderFactory._BROKER_PROVIDER.connect()
